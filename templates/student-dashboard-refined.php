...
// Include refined components
require_once(TFSP_PLUGIN_PATH . 'templates/components/scheduling-calendar.php');
require_once(TFSP_PLUGIN_PATH . 'templates/components/dual-messaging.php');
...
// Refined roadmap steps with Test Scores added
$roadmap_steps = array(
    'academic_resume' => array('title' => 'Academic Resume', 'color' => '#9c27b0', 'desc' => 'Build your academic achievements portfolio'),
    'personal_essay' => array('title' => 'Personal Essay', 'color' => '#e91e63', 'desc' => 'Write your compelling personal story'),
    'recommendation_letters' => array('title' => 'Recommendation Letters', 'color' => '#f44336', 'desc' => 'Teachers/coaches submit via designated link'),
    'transcript' => array('title' => 'Transcript', 'color' => '#ff9800', 'desc' => 'Official academic records'),
    'financial_aid' => array('title' => 'Financial Aid', 'color' => '#009688', 'desc' => 'Apply for scholarships and grants'),
    'community_service' => array('title' => 'Community Service', 'color' => '#2196f3', 'desc' => 'Document volunteer activities'),
    'college_list' => array('title' => 'Interest List of Colleges', 'color' => '#673ab7', 'desc' => 'Research and list target schools'),
    'college_tours' => array('title' => 'College Tours', 'color' => '#ff5722', 'desc' => 'Visit campuses and attend info sessions'),
    'fafsa' => array('title' => 'FAFSA', 'color' => '#1a237e', 'desc' => 'Complete federal financial aid application'),
    'test_scores' => array('title' => 'Test Scores', 'color' => '#795548', 'desc' => 'SAT/ACT scores and preparation')
);
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .recommendation-notice { background: #fff3cd; border: 1px solid #ffeaa7; border-radius: 8px; padding: 15px; margin: 10px 0; }
        .recommendation-notice h5 { margin: 0 0 8px; color: #856404; }
        .recommendation-notice p { margin: 0; color: #856404; font-size: 14px; }
...
<div class="container">
    ...
    <div class="section">
        ...
        <p>Track your college application progress, upload important documents, and stay connected with your dedicated <strong>College and Career Coach</strong>. Every step you complete brings you closer to your dream college!</p>
    </div>
    ...
    <div class="section">
        ...
        <div class="roadmap-grid">
            ...
            ?>
                <div class="roadmap-card" style="border-color: <?php echo $step_data['color']; ?>;" data-step="<?php echo $step_key; ?>">
                    <div class="card-number" style="background: <?php echo $step_data['color']; ?>;"><?php echo $index + 1; ?></div>
                    <div class="card-content">
                        <h4><?php echo $step_data['title']; ?></h4>
                        <p><?php echo $step_data['desc']; ?></p>
                        
                        <?php if ($step_key === 'recommendation_letters'): ?>
                            <div class="recommendation-notice">
                                <h5>📧 Special Process</h5>
                                <p>You do NOT upload recommendation letters directly. Your teachers/coaches will submit them via a designated link or email/Google Form provided by the admin.</p>
                            </div>
                        <?php endif; ?>
    ...
    <div class="section">
        ...
        <p><strong>Updated Status Options:</strong> Submitted, Accepted, Sent Back for Further Development</p>
                    ...
                    <div class="document-item">
                        ...
                        ?>">
                            ...
                            $status_labels = array(
                                'submitted' => 'Submitted',
                                'accepted' => 'Accepted', 
                                'needs_revision' => 'Sent Back for Development'
                            );
    ...
    <?php render_dual_messaging($current_user->ID); ?>
    
    <!-- 30-Day Calendar Scheduling -->
    <?php render_scheduling_calendar(); ?>
